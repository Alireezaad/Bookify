...
namespace Bookify.Infrastracture.Migrations
{
    ...
    [Migration("20250209074246_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookify.Domain.Booking.Booking", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Booking.Booking", b =>
                {
                    ...
                    b.HasOne("Bookify.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_bookings_user_id");
            ...
            modelBuilder.Entity("Bookify.Domain.Reviews.Review", b =>
                {
                    ...
                    b.HasOne("Bookify.Domain.Booking.Booking", null)
                        .WithMany()
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
